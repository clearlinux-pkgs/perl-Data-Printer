...
Source0  : https://cpan.metacpan.org/authors/id/G/GA/GARU/Data-Printer-1.000002.tar.gz
...
%prep
%setup -q -n Data-Printer-1.000002
cd %{_builddir}
tar xf %{_sourcedir}/libdata-printer-perl_0.40-1.debian.tar.xz
cd %{_builddir}/Data-Printer-1.000002
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Data-Printer-1.000002/deblicense/
