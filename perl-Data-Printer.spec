...
Version  : 1.000000
Release  : 20
URL      : https://cpan.metacpan.org/authors/id/G/GA/GARU/Data-Printer-1.000000.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/G/GA/GARU/Data-Printer-1.000000.tar.gz
...
%prep
%setup -q -n Data-Printer-1.000000
cd %{_builddir}
tar xf %{_sourcedir}/libdata-printer-perl_0.40-1.debian.tar.xz
cd %{_builddir}/Data-Printer-1.000000
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Data-Printer-1.000000/deblicense/
